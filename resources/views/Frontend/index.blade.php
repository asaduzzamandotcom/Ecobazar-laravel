@extends('layouts.FrontendLayout')
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col bannerText">
                                        ...
                                        <h1>Fresh & Healthy
                                            Organic Food</h1>
                                        <span>Free shipping on all your order. we deliver, you enjoy</span>
                                        <button>Shop Now <iconify-icon
                                                icon="mdi-light:arrow-right"></iconify-icon></button>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
            ...
            <div class="container">
                <div class="headers">
                    ...
                    <div class="navigation">
                        ...
                        <a type="button" href="shop.html" class="">View All</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="cart Vegetables ">
                                ...
                                <div class="iconBox">
                                    ...
                                    <div class="View">
                                        <iconify-icon icon="ant-design:eye-outlined" width="20"
        ...
        <section id="drinks">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-4 milk text-start">
                        <h4>100% Fresh <br>
                            Cow Milk</h4>
                        <p>Starting at <span>$14.99</span></p>
                        <button>Shop Now <iconify-icon icon="ri:arrow-right-line"></iconify-icon></button>
                    </div>
                    <div class="col-4 softDrinks text-end">
                        <p>Drink Sale</p>
                        <h4>Water & <br>
                            Soft Drink</h4>
                        <button>Shop Now <iconify-icon icon="ri:arrow-right-line"></iconify-icon></button>
                    </div>
                    <div class="col-4 breakfast">
                        <p>100% Organic</p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 text-center middleItems">
                        ...
                        <div class="countdown-container" data-date="apr 30, 2025 12:00:00">
                                    ...
                                    <div class="cart Vegetables ">
                                        <a href="#">
                                            ...
                                            <div class="details text-start">
                                                <a href="#">Big Potatos</a>
                                                <div
                                                    class="priceAndCard d-flex align-items-center justify-content-between">
                                                    <div class="price">
                                                        <span class="col-2">$14.99</span>
                                                    </div>
                                                    <span class="text-end col-6 addCatdBtn">
                                                        <iconify-icon icon="ph:handbag" width="20"
                                                            height="20"></iconify-icon>
                                                    </span>
                                                </div>
                                                <div class="review">
                                        ...
                                        <div class="iconBox">
                                            <div class="Wishlist">
                                                <iconify-icon icon="meteor-icons:heart" width="20"
                                                    height="20"></iconify-icon>
                                            </div>
                                            <div class="View">
                                                <iconify-icon icon="ant-design:eye-outlined" width="20"
                ...
                <div class="row">
                    <div class="col-lg-4 col-12">
                        <div class="reviewCnt text-center">
                            ...
                            <p>“Aenean et nisl eget eros consectetur vestibulum vel id erat. Aliquam feugiat massa dui.
                                Sed
                                sagittis diam sit amet ante sodales semper. Aliquam commodo lorem laoreet ultricies ele.
                                ”</p>
                        </div>
        ...
        <section id="video">
            <div class="container">
                <div class="row">
                    <img class="img-fluid vid" src="{{ asset('frontend/assets/img/Video.png')}}" alt="">
                    <div class="video">
                        <video id="video-m" src="{{ asset('frontend/assets/img/Creative IT Institute 16 Years of Grace Coming Soon!.mp4')}}"
                            controls class="d-none"></video>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="newsCnt text-center">
                            ...
                            <div class="text text-start">
                                ...
                                <span>Nulla libero lorem, euismod venenatis nibh sed, sodales dictum ex. Etiam nisi
                                    augue,
